        ...
        <div className="absolute top-2 left-2 flex flex-col gap-1">
          ...
          {label.packageInfo && (
            <div className="bg-orange-500 text-white text-[9px] font-black px-2 py-1 rounded shadow-lg uppercase tracking-wider flex items-center gap-1">
              <svg className="w-2 h-2" fill="currentColor" viewBox="0 0 20 20"><path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z"/></svg>
        ...
        <div className="fixed inset-0 z-[500] bg-slate-900/95 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-5xl h-[85vh] rounded-3xl shadow-2xl overflow-hidden flex flex-col">
            ...
            <div className="flex border-b bg-slate-50/50">
              ...
              <TabButton active={modalTab === 'hex'} onClick={() => setModalTab('hex')} label="Mapa Caracteres" />
                ...
                <div className="space-y-6">
                  {debugImage && (
                    <div className="bg-white border p-4 rounded-xl shadow-sm">
                      <h4 className="text-[10px] font-black text-slate-400 uppercase mb-2">Imagen de Lectura:</h4>
                  ...
                  <div className="bg-slate-900 rounded-2xl p-8 text-green-400 font-mono text-lg border border-slate-800 shadow-2xl min-h-full">
                    {label.rawBarcodeText || "Sin lectura DataMatrix."}
                  </div>
                </div>
              )}
            </div>
